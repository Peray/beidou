<template>
    <div class="posquery">
        ...
        <el-collapse-transition>
            <el-form status-icon :model="filterBeanForm" :inline="true" v-show="filterMenuShowing">
                ...
                <el-form-item>
                    <el-button type="primary" @click="queryLocateMessageList">查询</el-button>
                </el-form-item>
            </el-form>
        </el-collapse-transition>
        ...
        <div class="bodyStyle">
            <el-table ref="bdCardTable" :data="respTableData"
                ...
                <el-table-column label="高程" prop="alt">
                </el-table-column>

                <el-table-column label="速度" prop="speed">
                </el-table-column>

                <el-table-column label="方向" prop="angle">
                </el-table-column>

                <el-table-column label="时间" prop="locationTime" sortable>
                    <template slot-scope="scope">
                        {{new Date(scope.row.locationTime).toLocaleString()}}
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            queryLocateMessageList: function () {
            ...
            requestList: function (param) {
                this.$http.get(config.locateMessageQuery, {params: param}).then(response => {
                        if (response.ok) {
