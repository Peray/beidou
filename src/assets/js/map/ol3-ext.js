 ...
 * @return {olx.animationControler} an object to control animation with start, stop and isPlaying function
*/
ol.layer.Vector.prototype.animateFeature = function(feature,style, fanim)
{	var self = this;
	var listenerKey;
	// Save style
	...
	{	event.vectorContext = e.vectorContext;
		...
		// console.log(event.style[1].image_.rotation_);
		// feature.style.getImage().setRotation(rotation);
...
{	options = options || {};
	...
	this.isFollow_ = options.isFollow;
...
{	// First time 
	...
	{	p0 = p;
		...
		d += dl;
		var p2 = this.path_[i+1];
		var rotation = Math.atan2(p2[1]-p[1], p2[0]-p[0])- Math.PI / 180 * -90;
		//debug
		// e.style[1].image_.rotation_ = -rotation;
		e.style[0].getImage().setRotation(-rotation);
		// debugger
		e.style[1].getImage().setRotation(-rotation);
		// console.log(this.path_[i]);
	}
